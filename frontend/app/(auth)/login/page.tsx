        ...
        <div className="relative w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/5 bg-white/5 py-4 pl-6 pr-4 text-sm focus:border-sky-500/50 focus:outline-none placeholder:text-gray-600 transition-all"
                required
              />
              ...
              <input
                ...
                className="w-full rounded-2xl border border-white/5 bg-white/5 py-4 pl-6 pr-4 text-sm focus:border-sky-500/50 focus:outline-none transition-all placeholder:text-gray-600"
                required
              />
